...
fn test_mock_unknown_symbol_is_err() -> Result[Unit, Str] {
  match mock.get_quote("ZZZZ") {
    Err(SymbolNotFound(sym)) => assert_true(sym == "ZZZZ", "sym"),
...
fn suite() -> List[Result[Unit, Str]] {
  [test_mock_aapl_returns_quote(), test_mock_msft_returns_quote(), test_mock_unknown_symbol_is_err(), test_mock_reference_price_aapl(), test_mock_reference_price_unknown(), test_mid_price(), test_spread()]
}
